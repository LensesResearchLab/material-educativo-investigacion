...
```mermaid
graph LR
    A((Login Page)) -- Click 'Submit' --> B((Dashboard))
    B -- Click 'Menu' --> C((Settings))
    B -- Click 'Logout' --> A
    C -- Click 'Back' --> B
```
...
<img width="732" height="464" alt="img-01" src="https://github.com/user-attachments/assets/0b77cf98-5bf0-4835-9ef2-9a9667e2b289" />
...
1. Visitará el *Login*.
2. No encontrará enlaces (`<a>`), porque el botón de login es un `<input type="submit">` o un botón que ejecuta un form, y *Swag Labs* no tiene enlaces de navegación en la portada (salvo quizás redes sociales que filtramos).
...
<img width="944" height="375" alt="img-02" src="https://github.com/user-attachments/assets/81f270a8-79d8-437a-b8e3-1614c1b10b28" />
...
<img width="736" height="916" alt="img-03" src="https://github.com/user-attachments/assets/9c33e237-c546-4736-85e3-b8565ac60748" />
...
<img width="300" height="545" alt="img-04" src="https://github.com/user-attachments/assets/d496a5be-7b1d-4712-bf1a-056ea5b94d66" />
