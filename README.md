...
```mermaid
graph LR
    A[Node.js Process] -->|Controla| B[Cypress Binary]
    B -->|Lanza| C[Browser Process]
    C -.->|Renderizado Invisible| D[Memoria RAM]
    C -->|Reporta Estado| B
    B -->|Logs en Texto| A
    A -->|Salida| E[Terminal del Usuario]
...
<img width="848" height="951" alt="img-01" src="https://github.com/user-attachments/assets/33c1824f-a746-4922-9d04-da35b60c1587" />
...
classDiagram
    ...
    TestSpec --> LoginPage : Llama métodos
    TestSpec --> FixtureData : Consume datos
    LoginPage --> WebPage : Interactúa con el DOM
```
...
<img width="1324" height="901" alt="img-02" src="https://github.com/user-attachments/assets/43dce840-9f0e-47b4-b38c-33ea214bfff8" />
...
<img width="1512" height="836" alt="img-03" src="https://github.com/user-attachments/assets/0d2bb4e9-bcac-4e4b-b7fc-c980748bf7c2" />
...
El código final de este ejercicio está disponible en: [Cypress Headless](https://github.com/LensesResearchLab/material-educativo-investigacion)
